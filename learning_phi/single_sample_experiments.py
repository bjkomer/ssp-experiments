...
parser.add_argument('--n-train-samples', type=int, default=100)
...
parser.add_argument('--n-steps', type=int, default=100, help='number of successive steps per sample')
    ...
    for limit in limits:
        for ssp_dim in ssp_dims:
            for coord_dim in coord_dims:
                ...
                fname = 'output/single_step_learned_phi_results_{}D_{}dim_{}limit.npz'.format(args.coord_dim, args.ssp_dim, args.limit)
