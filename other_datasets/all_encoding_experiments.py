...
parser.add_argument('--limit-low', type=float, default=-1)
parser.add_argument('--limit-high', type=float, default=1)
...
def main():
    ...
    for i, classification_dataset in enumerate(datasets):
        ...
        elif args.encoding_type == 'all-ssp':
            enc_types = ['independent-ssp', 'combined-ssp', 'combined-simplex-ssp']
        elif args.encoding_type == 'all-other':
                                    ...
                                    df = df.append(
                                        {
                                            ...
                                            'N-Tiles': args.n_tiles if enc_type == 'tile-coding' else 0,
                                            'Sigma': args.sigma if enc_type == 'pc-guass' else 0,
